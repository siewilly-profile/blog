# 互補團隊
## 題解
此題需要的先知條件是，程式中二進位就跟開關一樣，1為open，0為close，現在這題我們就需要用到這個觀念。

題目有題到m為大寫A到Z，那我們可以模擬一件事情二進位`1 1 1 1`就像是`D C B A`一樣，如果這個A是已存在的，其他不存在就是`0 0 0 1`，以此類推
